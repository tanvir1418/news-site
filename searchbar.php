            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  <?php 
                        ...
                        $result = mysqli_query($conn, $sql) or die("Query Failed in searching.");
                    ...
                    $result1 = mysqli_query($conn, $sql1) or die("Query Failed in pagination");
                    ...
                    if(mysqli_num_rows($result1) > 0){
                        ...
                        for($i=1; $i<=$total_page; $i++){
                            ...
                            echo '<li><a class="'.$active.'" href="index.php?search='.$search_term.'&page='.$i.'">'.$i.'</a></li>';
